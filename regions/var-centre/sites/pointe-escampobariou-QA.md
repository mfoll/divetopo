...
- Le layout régional pending est `side=left`, `shiftYRem=3.5`, `labelOffsetRem=-1.15`, `widthRem=5.8`, `connectorAngleDeg=0`, `connectorWidthRem=2.6`, avec `Escampobariou` conservé intact sur une ligne. Le décalage supplémentaire de `1 rem` vers la droite maintient le cartouche dans le cadre aux largeurs intermédiaires, tout en utilisant l’espace libéré au sud-ouest après la consolidation du Langoustier ; le point et le connecteur de Cap des Mèdes restent entièrement visibles.
- Mesure DOM finale de l’overlay local à `800 × 900` : carte `x=128..672`, cartouche Escampobariou `x=189,12..284,63`. À `390 × 844` : carte `x=12..378`, cartouche `x=35,27..130,78`. Aux deux largeurs, le cartouche est entièrement dans la carte ; les contrôles donnent zéro collision avec les autres cartouches, l’échelle et le nord, sans débordement horizontal. Le pending reste non cliquable et en préparation.
