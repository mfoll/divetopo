...
export default function PreferenceControls({
  ...
  return (
    <div className="preference-controls">
      <fieldset className="preference-segmented language-control">
      ...
      <fieldset className="preference-segmented theme-control">
        <legend className="sr-only">{labels.themeGroup}</legend>
        {themeOptions.map((option) => (
          <span className="preference-segment" key={option}>
            <input
