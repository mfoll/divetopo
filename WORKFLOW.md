...
- `vertical_exaggeration` : facteur sans dimension entre l'echelle verticale et l'echelle horizontale du rendu. Sa signification reste stable lorsque la resolution du raster, le canevas ou la largeur visible changent.
